...
if (array_is_list($property) === false) {
    return $item;
        ...
        if (in_array(needle:'file', haystack: array_column(array: $property, column_key: 'type')) === true
             ...
             * @param bool       $files    Whether to include files in the retrieved object.
             * 
             ...
             * @param int|null $depth  The depth of the extension
             * 
            ...
            public function extendEntity(array $entity, array $extend, ?int $depth = 0): array
            {
                ...
                public function getRelations(string $id, ?int $register = null, ?int $schema = null): array
                {
                    ...
                    return array_filter(
                        $referencingObjects, function ($referencingObject) use ($id) {
